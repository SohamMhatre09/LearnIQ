...
# Check if we're running this script from the LearnIQ directory
if [ -d "/home/soham/LearnIQ/user-api" ]; then
    print_status "Copying user-api files from local directory..."
    cp -r /home/soham/LearnIQ/user-api/* .
    cp /home/soham/LearnIQ/user-api/.* . 2>/dev/null || true  # Copy hidden files
    ...
    print_error "1. You're running this script from a system with access to /home/soham/LearnIQ/user-api"
...
# Configure PM2 ecosystem file for user-api
